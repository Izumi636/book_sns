            ...
            <div class="col-md-5 mb-4">
                <form action="{{route('reviews.update', $review->id )}}" method="post">
                    ...
                    <div class="row mt-2">
                        ...
                        <textarea name="body" id="body" rows="5" placeholder="Enter your review" class="form-control">{{old('body', $review->body)}}</textarea>
                    </div>
                    <div class="row mt-2">
                        <label for="stars" class="form-label">Stars</label>
                        <select name="stars" id="stars" class="form-select form-select-lg" aria-label=".form-select-lg stars">
                            <option selected>{{old('stars', $review->stars)}}</option>
