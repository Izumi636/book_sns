...
@section('content')
    <div class="row justify-content-center">
        <div class="col-8">
            ...
            " method="post" class="bg-white shadow rounded-3 p-5" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="introduction" id="introduction" class="form-control" rows="5" placeholder="Describe yourself">{{old('introduction', $user->introduction)}}</textarea> 
                    {{-- error --}}
                    @error('introduction')
                    <p class="text-danger small">{{$message}}</p>
                    @enderror
