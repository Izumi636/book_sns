            ...
            <div class="row justify-content-center">
                ...
                @foreach ($user->following as $following)
                    <div class="row align-items-center mt-3">
                        <div class="col-auto">
                            <a href="{{route('profiles.show',$following->following->id)}}">
                                ...
                                @else
                                    <i class="fa-solid fa-circle-user text-secandary icon-sm"></i>
                                @endif
                            </a>
                        </div>
                    
                        <div class="col ps-0 text-truncate">
                            <a href="{{route('profiles.show', $following->following->id)}}" class="text-decoration-none text-dark fw-bold">{{$following->following->name}}</a>
                        </div>
