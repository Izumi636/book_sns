                ...
                <div class="col-4">
                    ...
                    @foreach ($user->followers as $follower)
                        <div class="row align-items-center mt-3">
                            {{-- avatar --}}
                            <div class="col-auto">
                                <a href="{{route('profiles.show', $follower->follower->id)}}">
                            ...
                            <div class="col ps-0 text-truncate">
                                <a href="{{route('profiles.show', $follower->follower->id)}}" class="text-decoration-none text-dark fw-bold">{{$follower->follower->name}}</a>
                            </div>
